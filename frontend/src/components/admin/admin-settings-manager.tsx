...
export function AdminSettingsManager() {
  ...
  const save = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setMessage(
        "Settings were not saved. Check the bilingual fields, selected managed media, and HTTPS social links.",
      );
    }
  };
  ...
  const updatePrinciple = (index: number, key: keyof AdminSiteSettingsPrinciple, value: string) => {
    if (settings === null) return;
    ...
    <section className="admin-settings" aria-labelledby="settings-title">
      ...
      <form className="admin-settings__form" onSubmit={save}>
        <fieldset className="admin-settings__section">
          ...
          <div className="admin-editor__grid">
            <label className="admin-editor__field">
              ...
              <input
                onChange={(event) => set("studio_name", event.target.value)}
            ...
            <label className="admin-editor__field">
              ...
              <select
                onChange={(event) =>
                  set("default_theme", event.target.value as AdminSiteSettings["default_theme"])
                }
            ...
            <AdminMediaPicker
              onSelect={(asset) => set("logo_media_id", asset.id)}
              selectedIds={settings.logo_media_id ? [settings.logo_media_id] : []}
              title="Logo image"
            />
            {settings.logo_media_id ? (
              <button onClick={() => set("logo_media_id", null)} type="button">
                Remove logo image
              </button>
            ) : null}
            <AdminMediaPicker
              onSelect={(asset) => set("favicon_media_id", asset.id)}
              selectedIds={settings.favicon_media_id ? [settings.favicon_media_id] : []}
              title="Browser icon image"
            />
            {settings.favicon_media_id ? (
              <button onClick={() => set("favicon_media_id", null)} type="button">
                Remove browser icon image
              </button>
            ) : null}
            <label className="admin-editor__field">
            ...
            <label className="admin-editor__field">
              ...
              <textarea
                onChange={(event) => set("contact_address_en", event.target.value)}
            ...
            <label className="admin-editor__field">
              ...
              <textarea
                dir="rtl"
                onChange={(event) => set("contact_address_fa", event.target.value)}
                value={settings.contact_address_fa ?? ""}
              />
            </label>
          </div>
          <div className="admin-settings__collection">
            <div className="admin-settings__collection-heading">
              <h2>Social links</h2>
              <button
                onClick={() => set("social_links", [...settings.social_links, emptySocialLink])}
                type="button"
              >
                Add link
              </button>
              ...
              <div className="admin-settings__pair" key={`${link.label}-${index}`}>
                ...
                <button
                  ...
                  onClick={() =>
                    set(
                      "social_links",
                      settings.social_links.filter((_, position) => position !== index),
                    )
                  }
                  type="button"
                >
        ...
        <fieldset className="admin-settings__section">
          ...
          <div className="admin-editor__grid">
            <label className="admin-editor__field">
              <span>Title / EN</span>
              <input
                onChange={(event) => set("default_seo_title_en", event.target.value)}
                value={settings.default_seo_title_en ?? ""}
              />
            </label>
            <label className="admin-editor__field">
              <span>Title / FA</span>
              <input
                dir="rtl"
                onChange={(event) => set("default_seo_title_fa", event.target.value)}
                value={settings.default_seo_title_fa ?? ""}
              />
            </label>
            <label className="admin-editor__field admin-editor__field--wide">
              <span>Description / EN</span>
              <textarea
                onChange={(event) => set("default_seo_description_en", event.target.value)}
                value={settings.default_seo_description_en ?? ""}
              />
            </label>
            <label className="admin-editor__field admin-editor__field--wide">
              ...
              <textarea
                dir="rtl"
                onChange={(event) => set("default_seo_description_fa", event.target.value)}
                value={settings.default_seo_description_fa ?? ""}
              />
            </label>
          </div>
        </fieldset>
        ...
        <fieldset className="admin-settings__section" id="home">
          ...
          <div className="admin-settings__home-sections">
            <details className="admin-settings__home-section" open>
              <summary>
                <strong>Opening image and introduction</strong>
                <span>The first image and text visitors see.</span>
              </summary>
              <div className="admin-editor__grid">
                <label className="admin-editor__field admin-editor__field--wide">
                  <span>Home title / EN</span>
                  <textarea
                    onChange={(event) => set("home_title_en", event.target.value)}
                    value={settings.home_title_en}
                  />
                </label>
                <label className="admin-editor__field admin-editor__field--wide">
                  <span>Home title / FA</span>
                  <textarea
                    dir="rtl"
                    onChange={(event) => set("home_title_fa", event.target.value)}
                    value={settings.home_title_fa}
                  />
                </label>
                <label className="admin-editor__field admin-editor__field--wide">
                  <span>Home body / EN</span>
                  <textarea
                    onChange={(event) => set("home_body_en", event.target.value)}
                    value={settings.home_body_en}
                  />
                </label>
                <label className="admin-editor__field admin-editor__field--wide">
                  <span>Home body / FA</span>
                  <textarea
                    dir="rtl"
                    onChange={(event) => set("home_body_fa", event.target.value)}
                    value={settings.home_body_fa}
                  />
                </label>
                <AdminMediaPicker
                  onSelect={(asset) => set("home_hero_media_id", asset.id)}
                  selectedIds={settings.home_hero_media_id ? [settings.home_hero_media_id] : []}
                  title="Home hero image"
                />
                {settings.home_hero_media_id ? (
                  <button onClick={() => set("home_hero_media_id", null)} type="button">
                    Remove home hero image
                  </button>
                ) : null}
              </div>
            </details>
            <details className="admin-settings__home-section">
              <summary>
                <strong>Selected projects</strong>
                <span>The heading above featured projects.</span>
              </summary>
              <div className="admin-editor__grid">
                <label className="admin-editor__field admin-editor__field--wide">
                  ...
                  <input
                    onChange={(event) =>
                      set("home_selected_projects_heading_en", event.target.value)
                    }
                ...
                <label className="admin-editor__field admin-editor__field--wide">
                  ...
                  <input
                    dir="rtl"
                    onChange={(event) =>
                      set("home_selected_projects_heading_fa", event.target.value)
                    }
            ...
            <details className="admin-settings__home-section">
              <summary>
                <strong>Studio feature</strong>
                <span>Text and image that introduce the studio.</span>
              </summary>
              <div className="admin-editor__grid">
                <label className="admin-editor__field admin-editor__field--wide">
            ...
            <details className="admin-settings__home-section">
              <summary>
                <strong>Expertise feature</strong>
                <span>The heading and image that lead to expertise.</span>
              </summary>
              <div className="admin-editor__grid">
                <label className="admin-editor__field admin-editor__field--wide">
            ...
            <details className="admin-settings__home-section">
              <summary>
                ...
                <span>The heading above the studio process.</span>
              </summary>
              <div className="admin-editor__grid">
                <label className="admin-editor__field admin-editor__field--wide">
            ...
            <details className="admin-settings__home-section">
              <summary>
                ...
                <span>The heading above recent journal articles.</span>
              </summary>
              <div className="admin-editor__grid">
                <label className="admin-editor__field admin-editor__field--wide">
            ...
            <details className="admin-settings__home-section">
              <summary>
                <strong>Contact invitation</strong>
                <span>The final invitation to get in touch.</span>
              </summary>
              <div className="admin-editor__grid">
                <label className="admin-editor__field admin-editor__field--wide">
        ...
        <fieldset className="admin-settings__section" id="studio">
          ...
          <div className="admin-editor__grid">
            <label className="admin-editor__field admin-editor__field--wide">
              ...
              <textarea
                onChange={(event) => set("studio_intro_en", event.target.value)}
                value={settings.studio_intro_en}
              />
            </label>
            <label className="admin-editor__field admin-editor__field--wide">
              <span>Studio introduction / FA</span>
              <textarea
                dir="rtl"
                onChange={(event) => set("studio_intro_fa", event.target.value)}
                value={settings.studio_intro_fa}
              />
            </label>
          </div>
          <div className="admin-settings__collection">
            <div className="admin-settings__collection-heading">
              ...
              <button
                onClick={() =>
                  set("studio_principles", [...settings.studio_principles, emptyPrinciple])
                }
                type="button"
              >
                Add principle
            ...
            {settings.studio_principles.map((principle, index) => (
              <div className="admin-settings__principle" key={`${principle.title_en}-${index}`}>
                <label className="admin-editor__field">
                  <span>Title / EN</span>
                  <input
                    onChange={(event) => updatePrinciple(index, "title_en", event.target.value)}
                    value={principle.title_en}
                  />
                </label>
                <label className="admin-editor__field">
                  <span>Title / FA</span>
                  <input
                    dir="rtl"
                    onChange={(event) => updatePrinciple(index, "title_fa", event.target.value)}
                    value={principle.title_fa}
                  />
                </label>
                <label className="admin-editor__field">
                  <span>Body / EN</span>
                  <textarea
                    onChange={(event) => updatePrinciple(index, "body_en", event.target.value)}
                    value={principle.body_en}
                  />
                </label>
                <label className="admin-editor__field">
                  <span>Body / FA</span>
                  <textarea
                    dir="rtl"
                    onChange={(event) => updatePrinciple(index, "body_fa", event.target.value)}
                    value={principle.body_fa}
                  />
                </label>
                <button
                  className="admin-project-row__delete"
                  onClick={() =>
                    set(
                      "studio_principles",
                      settings.studio_principles.filter((_, position) => position !== index),
                    )
                  }
                  type="button"
                >
        ...
        <fieldset className="admin-settings__section">
          ...
          <div className="admin-editor__grid">
            <label className="admin-editor__field admin-editor__field--wide">
              <span>Privacy text / EN</span>
              <textarea
                onChange={(event) => set("privacy_en", event.target.value)}
                value={settings.privacy_en}
              />
            </label>
            <label className="admin-editor__field admin-editor__field--wide">
              <span>Privacy text / FA</span>
              <textarea
                dir="rtl"
                onChange={(event) => set("privacy_fa", event.target.value)}
                value={settings.privacy_fa}
              />
            </label>
          </div>
        </fieldset>
